...
class ArticleSeeder extends Seeder
{
    public function run()
    {
        ...
        for ($i=18;$i<27;$i++) {
            ...
            $article->categories()->sync(Category::where('name', 'Bangladesh')->first());
        }
        ...
        for ($i=30;$i<42;$i++) {
            ...
            $article->categories()->sync(Category::where('name', 'International')->first());
        }
        ...
        for ($i=40;$i<55;$i++) {
            ...
            $article->categories()->sync(Category::where('name', 'sports')->first());
        }
        ...
        for ($i=55;$i<66;$i++) {
            ...
            $article->categories()->sync(Category::where('name', 'recreation')->first());
        }
    }
}
